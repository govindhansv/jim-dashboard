  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-6">
      <div className="mb-6">
        ...
        <h2 className="mt-1 text-2xl font-semibold text-slate-900">Activity feed</h2>
      </div>
      <div className="space-y-4">
        {activities.map((activity) => {
          ...
          return (
            <div key={activity.title} className="flex gap-4 rounded-2xl border border-slate-100 bg-white p-4 transition-all duration-200 hover:border-blue-300/40 hover:bg-slate-100/80">
